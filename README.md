...
* See some examples in [sample.js](https://github.com/RonnyO/js-motion-detection/blob/master/js/sample.js)
* Open up the demo **[here](http://reallygood.co.il/plugins/motion/)** (check the console).